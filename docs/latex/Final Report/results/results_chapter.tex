...
We decided to implement the fetching of data in a \textbf{lazy} manner using Kotlin's \textbf{Sequences} [ref] instead of Java 8
...
a Sequence via IterableUtils.asCachedSequence(), which also caches acquired values allowing for subsequent iterations.\\
