...
\begin{figure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=1.0]{_figures/login.png}
        \caption{Android client's login}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=1.0]{_figures/register.png}
        \caption{Android client's register}
    \end{subfigure}
\end{figure}

\subsubsection{User profile overview}

\begin{figure}
    \begin{center}
        \includegraphics[scale=1.0]{_figures/profileOverview.png}
        \caption{The user profile slide screen}
    \end{center}
\end{figure}


\subsubsection{User insulin profile creation}

\begin{figure}
    \begin{center}
        \includegraphics[scale=1.0]{_figures/insulinprofilecreation.png}
        \caption{Insulin profile creation fragment}
    \end{center}
\end{figure}
