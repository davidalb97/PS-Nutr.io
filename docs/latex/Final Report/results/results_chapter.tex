...
This token will be stored in the Android Shared Preferences and it will also to be renewed periodically due to its 10h expiration time. The user credentials will be also be saved
