...
\begin{figure}[H]
    \begin{center}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/register.png}
            \caption{The register fragment} 
        \end{subfigure}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/login.png}
            \caption{The login fragment} 
        \end{subfigure}%
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/firstSign.png}
...
\begin{figure}[H]
    \begin{center}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/addProfile.png}
            \caption{The fragment to add an insulin profile} 
        \end{subfigure}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/insulin_profiles_list.png}
...
\begin{figure}[H]
    \begin{center}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/calc_with_profile.png}
            \caption{Calculator with valid profile} 
        \end{subfigure}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/calc_without_profile.png}
...
\begin{figure}[H]
    \begin{center}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/fullfilled_calc.png}
            \caption{Calculator with all the valid field filled} 
        \end{subfigure}
        \begin{subfigure}{.3\textwidth}
            \includegraphics[scale=0.1]{_figures/dosage_result.png}
...
This web browser application will only serve the propose of moderation inside our platform, as we agreed that a good way to provide a good propose for this 
component was to not duplicate the mobile application functionalities and to extend the platform's features.\\
...
\subsubsection{Consult reports}

\subsubsection{Ban users}
