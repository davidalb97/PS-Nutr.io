...
such as JDBI's \textbf{ResultIterable} and \textbf{ResultIterator} classes (explained in the following section),
...
It should be noted that restaurants and meals can be votable, favorable and reportable, however there are some exceptions:
\begin{itemize}
