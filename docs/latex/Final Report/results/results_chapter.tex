...
BCrypt is a password-hashing function based on the Blowfish cipher. The group found this function very convenient for these reasons:
\begin{itemize}
    \item Already pre salts the passwords, preventing rainbow table attacks;
...
\textbf{TODO: application images and diagrams}
...
The group chose to build the website with JavaScript using the React framework, as it was the framework lectured in the Web applications
