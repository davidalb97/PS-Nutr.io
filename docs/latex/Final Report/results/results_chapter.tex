...
BCrypt is a password-hashing function based on the Blowfish\cite{blowfish} cipher. The group found this function very convenient for these reasons:
\begin{itemize}
...
In the application's code every fragment class has \textit{fragment} suffix.
