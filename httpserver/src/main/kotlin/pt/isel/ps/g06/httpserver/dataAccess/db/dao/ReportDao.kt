...
interface ReportDao {
    ...
    fun getAll(skip: Int?, count: Int?): Stream<DbReportDto>
    ...
    fun getAllReportedSubmissionsByType(submissionType: String, skip: Int?, count: Int?): Stream<DbReportedSubmissionDto>

    @SqlQuery("SELECT $table.$reportId, $table.$reporterId, $table.$description " +
            "FROM $table WHERE $table.$submissionId = :submissionId")
    fun getAllBySubmission(submissionId: Int): Stream<DbSubmissionReportDto>
