...
interface InsulinProfileDao {
    ...
    fun getAllFromUser(submitterId: Int, count: Int?, skip: Int?): Stream<DbUserEncInsulinProfileDto>
    ...
    fun deleteAllBySubmitterId(submitterId: Int): Stream<DbUserEncInsulinProfileDto>
