...
const val RESTAURANTS_PATH = "/$RESTAURANT"
...
const val USER_ID_PATH = "/$USER/{$USER_ID_VALUE}"
...
const val REPORTS_PATH = "/report"
const val REPORT_SUBMISSION_ID = "/report/{$SUBMISSION_ID_VALUE}"
const val REPORT_ID = "/report/{$REPORT_ID_VALUE}"
