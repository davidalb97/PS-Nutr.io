...
interface VotableDao {
    ...
    @SqlQuery("SELECT ? FROM $votableTable WHERE $submissionId = " +
            ":submissionId AND $voterSubmitterId = :voteSubmitterId")
    fun getVoteFromSubmitter(@Bind submissionId: Int, voteSubmitterId: Int): Boolean
