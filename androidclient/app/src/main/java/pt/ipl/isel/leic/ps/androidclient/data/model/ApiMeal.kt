...
data class ApiMeal(
    ...
    companion object CREATOR : Parcelable.Creator<ApiMeal> {
        override fun createFromParcel(parcel: Parcel): ApiMeal {
            return ApiMeal(parcel)
        }

        override fun newArray(size: Int): Array<ApiMeal?> {
